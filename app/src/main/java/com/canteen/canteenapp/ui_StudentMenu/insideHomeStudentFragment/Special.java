...
public class Special extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_home_student_special_tab, container, false);
        TextView noSpecialMenu = root.findViewById(R.id.noSpecialMenu);
        RecyclerView recycle = root.findViewById(R.id.recycleStudentSpecial);
        recycle.setHasFixedSize(true);
        recycle.setLayoutManager(new LinearLayoutManager(getContext()));

        StudentPrespectiveController po = new StudentPrespectiveController(getActivity());
        po.retriveFoodFromSellerSpecial(recycle , getActivity() , noSpecialMenu);
